 ...
 *
 * <p>Cada nodo conoce únicamente a su sucesor. La lista guarda una referencia al
 * primero y otra al último, de modo que agregar al final es O(1).</p>
 *
 * @param <T> tipo de elementos almacenados
 */
public class ListaSimplementeEnlazada<T> implements TDALista<T> {
     ...
     *
     * <p>Se mantiene para que agregar al final no requiera recorrer la lista.</p>
     */
    ...
    public T remover(int index) {
        ...
        if (index == 0) {
            ...
            // Si la lista quedó vacía, ultimo también debe soltarse.
            if (primero == null) {
                ultimo = null;
            }
        } else {
    ...
    public TDALista<T> ordenar(Comparator<T> comparator) {
        ...
        // Ordenamiento por mezcla: O(n log n) reenganchando punteros, sin arreglo auxiliar.
        resultado.primero = ordenarPorMezcla(resultado.primero, comparator);

        // La mezcla reordena la cadena, así que ultimo quedó desactualizado.
        resultado.ultimo = resultado.buscarUltimoNodo();
     ...
     *
     * <p>Aprovecha la referencia a ultimo como atajo cuando se pide la última posición.</p>
     */
    ...
    /**
     * Recorre la cadena y retorna su último nodo, o null si está vacía.
     */
